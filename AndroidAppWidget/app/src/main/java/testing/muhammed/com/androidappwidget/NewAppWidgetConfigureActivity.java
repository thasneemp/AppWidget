...
public class NewAppWidgetConfigureActivity extends Activity {
    ...
    private static final String PREFS_NAME = "testing.muhammed.com.androidappwidget.NewAppWidget";
    ...
    View.OnClickListener mOnClickListener = new View.OnClickListener() {
        public void onClick(View v) {
            ...
            NewAppWidget.updateAppWidget(context, appWidgetManager, mAppWidgetId, NewAppWidgetConfigureActivity.loadTitlePref(context, mAppWidgetId));
